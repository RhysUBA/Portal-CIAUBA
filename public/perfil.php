...
$userModel = new User();
$temaModel = new Tema();
$proyectoModel = new MiembroProyecto();
$eventoModel = new AsistenteEvento();
...
$temas = $temaModel->obtenerPorUsuario($usuario_id);
...
<div class="profile-details">
    <!-- Columna izquierda - Información personal y temas -->
    <div>
        ...
        <!-- Temas del usuario -->
        <div class="detail-section">
            <h3><i class="fas fa-comments"></i> Temas creados en el foro</h3>
            <?php if (empty($temas)): ?>
                <p class="text-muted">Aún no has creado ningún tema. <a href="nuevo_tema.php">¡Crea tu primer tema!</a></p>
            <?php else: ?>
                ...
                <?php endforeach; ?>
                <?php if (count($temas) > 5): ?>
                    <div style="text-align: center; margin-top: var(--space-sm);">
                        <a href="mis_temas.php" class="btn-link">Ver todos los temas</a>
                    </div>
                <?php endif; ?>
            <?php endif; ?>
        </div>
    ...
    <div>
        <!-- Proyectos -->
        <div class="detail-section">
            <h3><i class="fas fa-project-diagram"></i> Proyectos en los que participa</h3>
            <?php if (empty($proyectos)): ?>
                <p class="text-muted">No participa en ningún proyecto actualmente. 
                <?php if ($es_propio): ?>
                    <a href="proyectos.php">Explora proyectos disponibles</a>
                <?php endif; ?>
                </p>
            <?php else: ?>
                ...
                <?php if ($es_propio): ?>
                    <div style="text-align: center; margin-top: var(--space-sm);">
                        <a href="mis_proyectos.php" class="btn-link">Gestionar mis proyectos</a>
                    </div>
                <?php endif; ?>
            <?php endif; ?>
        </div>
        ...
        <div class="detail-section">
            ...
            <?php if (empty($eventos)): ?>
                <p class="text-muted">No tiene eventos próximos. 
                <?php if ($es_propio): ?>
                    <a href="eventos.php">Ver eventos disponibles</a>
                <?php endif; ?>
                </p>
            <?php else: ?>
                    ...
                    <div class="event-item">
                        <div>
                            ...
                            <div style="font-size: 0.85rem; color: #666;">
                                ...
                                <i class="fas fa-calendar-day"></i> <?php echo date('d/m/Y H:i', strtotime($evento['fecha_inicio'])); ?>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
                <?php if ($es_propio): ?>
                    <div style="text-align: center; margin-top: var(--space-sm);">
                        <a href="mis_eventos.php" class="btn-link">Ver todos mis eventos</a>
                    </div>
                <?php endif; ?>
            <?php endif; ?>
        </div>
        ...
        <?php if ($es_propio): ?>
            <div class="detail-section">
                ...
                <div class="profile-actions">
                    ...
                    <a href="recursos.php" class="cta-button">
                        <i class="fas fa-book"></i> Biblioteca de recursos
                    </a>
                </div>
            </div>
        <?php else: ?>
